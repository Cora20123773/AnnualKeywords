<template>
	<view class="previewImage" :style="{ 'background-color': 'rgba(0,0,0,' + opacity + ')' }" v-if="show" @tap="close" @touchmove.stop.prevent>
		...
		<view class="save" v-if="saveBtn" @tap.stop.prevent="save"><text class="text">保存</text></view>
		<view class="rotate" v-if="rotateBtn" @tap.stop.prevent="rotate"><text class="text">旋转</text></view>
